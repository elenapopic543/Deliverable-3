...
4. Vocabulary pruning: Filtering the words in the dataset to remove stop words and irrelevant words to facilitate meaningful analysis.  
...
Pruning the vocabulary by removing numbers, manually specified words, trailing "s" characters and empty values:
...
# Removing rows with empty values in the "EachWord" column:
plotdata_ascending = subset(plotdata_ascending, EachWord != "")
```
...
Legend_title="World Effective Governance Indicators\n(grey is missing)" 
